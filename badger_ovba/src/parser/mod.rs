...
impl<'a> Ovba<'a> {
    ...
    pub fn parse_independent_info(&mut self) -> Result<IndependentVbaProject, Error> {
        ...
        self.inner.open_stream(stream_name)?.read_to_end(&mut compressed_buffer)?;
    ...
    pub fn parse_modules(&mut self, data: &IndependentVbaProject) -> Result<Vec<OvbaModule>, Error> {
